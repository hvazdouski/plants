...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    caption_text = (
        ...
        f"Я раскажу об особенностях ЖКТ и важности правильного питания морских свинок, а также помогу понять, можно ли твоему питомцу то или иное растение, овощ, фрукт или ягоду, и в каком количестве.\n\n"
        f"🔍 Как пользоваться: выберите интересующий раздел ниже и хорошенького его изучи.\n\n"
        f"В скором времени ты сможешь написать название продукта в чат (например: огурец, петрушка, перец), а я выдам  информацию о пользе или вреде, а также норме потребления!
    )
